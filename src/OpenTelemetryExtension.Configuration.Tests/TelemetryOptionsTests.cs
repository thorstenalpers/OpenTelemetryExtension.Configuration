...
namespace OpenTelemetryExtension.Configuration.Tests
{
    public class TelemetryOptionsTests
    {
        ...
        [Fact]
        public void Defaults_Protocol_IsGrpc()
            => Assert.Equal(OtlpExportProtocol.Grpc, new TelemetryOptions().Protocol);
        ...
        [Fact]
        public void Defaults_EnableSqlClientInstrumentation_IsTrue()
            => Assert.True(new TelemetryOptions().EnableSqlClientInstrumentation);
        ...
        [Fact]
        public void Defaults_ExcludeHealthChecks_IsTrue()
            => Assert.True(new TelemetryOptions().ExcludeHealthChecks);
